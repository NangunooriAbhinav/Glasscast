...
export const GlassInput = React.forwardRef<TextInput, GlassInputProps>(
  (
    ...
    const handleClear = () => {
      onChangeText?.("");
      onClear?.();
      if ("current" in textInputRef && textInputRef.current) {
    ...
    const containerViewStyle: ViewStyle = useMemo(() => {
      const baseStyle: ViewStyle = {
        ...
        minHeight: multiline
          ? getSizeConfig.height * numberOfLines
    ...
    const textInputStyle: TextStyle = useMemo(
      ...
      [fontSize, getSizeConfig, fontWeight, textColor, multiline],
    );
      ...
      <View style={containerStyle}>
        ...
        {label && (
          <Text style={[labelTextStyle, labelStyle]}>
            {label}
            {required && <Text style={{ color: colors.accent.error }}> *</Text>}
          </Text>
        )}
...
export const UnderlinedGlassInput: React.FC<
  Omit<GlassInputProps, "variant">
> = (props) => <GlassInput {...props} variant="underlined" />;

export const BorderlessGlassInput: React.FC<
  Omit<GlassInputProps, "variant">
> = (props) => <GlassInput {...props} variant="borderless" />;
...
// Specialized inputs
export const SearchGlassInput = React.forwardRef<any, GlassInputProps>(
  (props, ref) => (
    <GlassInput
      ref={ref}
      {...props}
